...
from azure.DaveAdemResourceGroup import TableService, Entity
...
resourcegroup_name = 'dave'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'dave'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
location = 'eastus'
...
print('Created entry for a Arabica...\n')
time.sleep(1)
...
coffee.item = 'American'
coffee.cost = 8.66
table_service.insert_entity('itemstable', coffee)
print('Created entry for American...\n')
time.sleep(1)
